...
$active_record = TRUE;
//开发环境
$db['development']['hostname'] = '192.168.0.10';
$db['development']['port'] = '3306';
$db['development']['username'] = 'xrenwu';
$db['development']['password'] = '123456';
$db['development']['database'] = 'bb';
...
//测试环境
$db['testing']['hostname'] = '118.123.213.31';
$db['testing']['port'] = '8201';
$db['testing']['username'] = 'xrenwu';
$db['testing']['password'] = '123456';
$db['testing']['database'] = 'bb';
...
//公网
$db['production']['hostname'] = '10.0.0.14';
//$db['production']['port'] = '8201';
$db['production']['username'] = 'xrenwu';
$db['production']['password'] = '123456';
$db['production']['database'] = 'bb';
