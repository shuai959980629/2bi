 ...
 * Chinese
 *
 * Chinese Pinyin class loadingfor developers for PHP 4.3.2 or newer
 *
 * @package         Libraries
 * @author          Liu Guoqing
 ...
 * @date            2010.02.04
 * @license          
 * @link             http://hi.baidu.com/850317
 * @filesource 
 * QQ 603031225  MSN：DJBOY850317@live.cn
 */
...
class Chinese {
	...
	function Chinese() {
		...
		log_message ( 'debug', 'CentVox : Chinese class library loaded' );
	}
	...
	/**
	 * return  ASCII from  a charascter or  characters
	 */
...
// end of Chinese Library------------------Chinese.php