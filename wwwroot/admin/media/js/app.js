...
function validatePices(o) {
    var pice = o.value.replace(/^([1-9][0-9]{0,4}|[0-9])((\.[0-9]{0,2}){0,1})$/, '');
    if (pice.length > 0) {
...
function validatePhone(o) {
    var pice = o.value.replace(/^[0-9|-]{0,12}|[0-9]$/, '');
    if (pice.length > 0) {
        o.value = o.value.substring(0, o.value.length - 1);
        validatePhone(o);
    }
...
String.prototype.replaceAll = function (AFindText,ARepText){
 ...
 function replace_html(obj){
    var inner_html = obj.value.replaceAll('<', '&lt;').replaceAll('>', '&gt;');
    if (inner_html.length > 0) {
        obj.value = inner_html;//obj.value.substring(0, obj.value.length - 1);
    }
}
